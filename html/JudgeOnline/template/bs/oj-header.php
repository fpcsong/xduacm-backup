...
<div id=subhead>
	  ...
	  <?php $ACTIVE="btn-warning";?>
		...
		<a  class='btn <?php if ($url==$OJ_BBS.".php") echo " $ACTIVE";?>'  href="discuss/discuss.php">
	  ...
	  <!-- <a  class='btn </*?php if ($url=="submitpage.php") echo " $ACTIVE";?>' href="submitpage.php">
		...
		<!-- <a class='btn <?php if ($url=="/wiki") echo " $ACTIVE";?>' href="/wiki"> -->
                <!-- <i class="icon-comment"></i><?php echo "Wiki"?></a> -->
